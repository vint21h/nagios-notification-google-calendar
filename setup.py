...
setup(
    ...
    install_requires=["httplib2 == 0.19.0", "oauth2client == 1.0", "google-api-python-client == 1.0", ],
    package_data={
    ...
    download_url="https://github.com/vint21h/nagios-notification-google-calendar/archive{version}.tar.gz".format(version=__version__),
    zip_safe=False,
